...
The Al-Gore-ithm does a depth-first-search, leaving unique IDs on non-primitive values to know whether its seen them before. It then replaces these values with their ID and serializes. This allows for serialization of nested objects without ever getting stuck in circular reference loops.
